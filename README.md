...
if image is None:
    print("Image not found! Check the filename/path.")
else:
...
```
<img width="439" height="539" alt="Screenshot 2026-08-21 114933" src="https://github.com/user-attachments/assets/b5bf1b7c-3a13-4358-9bd3-4ae09ae85225" />


<img width="497" height="512" alt="Screenshot 2026-08-21 114938" src="https://github.com/user-attachments/assets/f733a34f-870d-4ef4-8b7f-370ebf53b48d" />
...
plt.axis('off')
```
<img width="783" height="373" alt="Screenshot 2026-08-21 114943" src="https://github.com/user-attachments/assets/d3cc4992-c6d9-4baa-a8ea-859be0cef818" />
...
plt.axis('off')
```
<img width="469" height="516" alt="Screenshot 2026-08-21 114949" src="https://github.com/user-attachments/assets/1fd76e63-c9b3-475b-ab70-8e46dea8a985" />
...
plt.axis('off')
```
<img width="421" height="511" alt="Screenshot 2026-08-21 114954" src="https://github.com/user-attachments/assets/8c66c8a8-1ec5-4f36-83f9-62128b9c4413" />
...
plt.axis('off')
```
<img width="416" height="514" alt="Screenshot 2026-08-21 115000" src="https://github.com/user-attachments/assets/707ab2b5-8e8f-4dff-b188-5b572169b83a" />
...
plt.axis('off')
```
<img width="619" height="515" alt="Screenshot 2026-08-21 115005" src="https://github.com/user-attachments/assets/ea613753-46bf-424c-aabd-d789bfdef730" />
